...
Examples:
  ...
  python pipeline.py discover --hashtag EDS --max-videos 100
    ...
    run_parser.add_argument('--max-song-ratio', type=float, default=0.33,
                           help='Skip videos with song_lyrics_ratio >= this (default: 0.33)')
    ...
    ex_parser.add_argument('--max-song-ratio', type=float, default=0.33,
                           help='Skip videos with song_lyrics_ratio >= this (default: 0.33)')
